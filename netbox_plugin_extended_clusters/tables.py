...
class AccessListTable(NetBoxTable):
    ...
    tags = columns.TagColumn(
        url_name="plugins:netbox_plugin_extended_clusters:accesslist_list",
    )
...
class ACLInterfaceAssignmentTable(NetBoxTable):
    ...
    tags = columns.TagColumn(
        url_name="plugins:netbox_plugin_extended_clusters:aclinterfaceassignment_list",
    )
...
class ACLStandardRuleTable(NetBoxTable):
    ...
    tags = columns.TagColumn(
        url_name="plugins:netbox_plugin_extended_clusters:aclstandardrule_list",
    )
...
class ACLExtendedRuleTable(NetBoxTable):
    ...
    action = ChoiceFieldColumn()
    tags = columns.TagColumn(
        url_name="plugins:netbox_plugin_extended_clusters:aclextendedrule_list",
    )
