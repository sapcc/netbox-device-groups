...
class ExtendedClusterTypeSerializer(NetBoxModelSerializer):
    """
    Defines the serializer for the django ExtendedClusterType model & associates it to a view.
    """
...
class AccessListSerializer(NetBoxModelSerializer):
    ...
    url = serializers.HyperlinkedIdentityField(
        view_name="plugins-api:netbox_plugin_extended_clusters-api:accesslist-detail",
    )
...
class ACLInterfaceAssignmentSerializer(NetBoxModelSerializer):
    ...
    url = serializers.HyperlinkedIdentityField(
        view_name="plugins-api:netbox_plugin_extended_clusters-api:aclinterfaceassignment-detail",
    )
...
class ACLStandardRuleSerializer(NetBoxModelSerializer):
    ...
    url = serializers.HyperlinkedIdentityField(
        view_name="plugins-api:netbox_plugin_extended_clusters-api:aclstandardrule-detail",
    )
    access_list = NestedAccessListSerializer()
...
class ACLExtendedRuleSerializer(NetBoxModelSerializer):
    ...
    url = serializers.HyperlinkedIdentityField(
        view_name="plugins-api:netbox_plugin_extended_clusters-api:aclextendedrule-detail",
    )
    access_list = NestedAccessListSerializer()
    source_prefix = NestedPrefixSerializer(
        required=False,
