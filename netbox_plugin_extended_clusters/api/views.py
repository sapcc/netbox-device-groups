...
__all__ = [
    "ExtendedClusterTypeListViewSet",
    "AccessListViewSet",
...
class ExtendedClusterTypeListViewSet(NetBoxModelViewSet):
    """
    Defines the view set for the django ExtendedClusterType model & associates it to a view.
    """

    queryset = models.ExtendedClusterType.objects.prefetch_related(
        "tags",
    )
    serializer_class = ExtendedClusterTypeSerializer
    filterset_class = filtersets.ExtendedClusterTypeFilterSet
