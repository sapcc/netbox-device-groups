...
from .models import ExtendedClusterType, AccessList, ACLExtendedRule, ACLInterfaceAssignment, ACLStandardRule
...
__all__ = (
    ...
    "ExtendedClusterTypeFilterSet",
)


class ExtendedClusterTypeFilterSet(NetBoxModelFilterSet):
    """
    Define the filter set for the django model ExtendedClusterType.
    """

    class Meta:
        """
        Associates the django model ExtendedClusterType & fields to the filter set.
        """
    ...
    def search(self, queryset, name, value):
        """
        Override the default search behaviour for the django model.
        """
