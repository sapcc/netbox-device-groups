...
class AccessListEditView(generic.ObjectEditView):
    ...
    template_name = "netbox_plugin_extended_clusters/accesslist_edit.html"
...
class AccessListChildView(generic.ObjectChildrenView):
    ...
    def get_extra_context(self, request, instance):
        return {
            ...
            "add_url": "plugins:netbox_plugin_extended_clusters:accesslist_add",
        }
...
class DeviceAccessListView(AccessListChildView):
    ...
    tab = ViewTab(
        ...
        permission="netbox_plugin_extended_clusters.view_accesslist",
    )
...
class ACLInterfaceAssignmentEditView(generic.ObjectEditView):
    ...
    template_name = "netbox_plugin_extended_clusters/aclinterfaceassignment_edit.html"
...
class ACLInterfaceAssignmentChildView(generic.ObjectChildrenView):
    ...
    def get_extra_context(self, request, instance):
        return {
            "table_config": self.table.__name__,
            "model_type": self.queryset.model._meta.verbose_name.replace(" ", "_"),
            "add_url": "plugins:netbox_plugin_extended_clusters:aclinterfaceassignment_add",
        }
...
class InterfaceACLInterfaceAssignmentView(ACLInterfaceAssignmentChildView):
    ...
    tab = ViewTab(
        ...
        permission="netbox_plugin_extended_clusters.view_aclinterfaceassignment",
    )
