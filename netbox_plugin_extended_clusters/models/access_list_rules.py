...
class ACLStandardRule(ACLRule):
    ...
    def get_absolute_url(self):
        ...
        """
        return reverse("plugins:netbox_plugin_extended_clusters:aclstandardrule", args=[self.pk])
...
class ACLExtendedRule(ACLRule):
    ...
    def get_absolute_url(self):
        ...
        it conveniently returns the absolute URL for any particular object.
        """
        return reverse("plugins:netbox_plugin_extended_clusters:aclextendedrule", args=[self.pk])
