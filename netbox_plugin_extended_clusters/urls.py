...
urlpatterns = (
    ...
    path(
        "access-lists/<int:pk>/",
        include(get_model_urls("netbox_plugin_extended_clusters", "accesslist")),
    ),
    ...
    path(
        "interface-assignments/<int:pk>/",
        include(get_model_urls("netbox_plugin_extended_clusters", "aclinterfaceassignment")),
    ),
    ...
    path(
        "standard-rules/<int:pk>/",
        include(get_model_urls("netbox_plugin_extended_clusters", "aclstandardrule")),
    ),
    ...
    path(
        "extended-rules/<int:pk>/",
        include(get_model_urls("netbox_plugin_extended_clusters", "aclextendedrule")),
    ),
)
