...
--
-- Name: netbox_physical_clusters_physicalclustertype; Type: TABLE; Schema: public; Owner: netbox
--

CREATE TABLE public.netbox_physical_clusters_physicalclustertype (
    id bigint NOT NULL,
    created timestamp with time zone,
    last_updated timestamp with time zone,
    custom_field_data jsonb NOT NULL,
...
ALTER TABLE public.netbox_physical_clusters_physicalclustertype OWNER TO netbox;

--
-- Name: netbox_physical_clusters_physicalclustertype_id_seq; Type: SEQUENCE; Schema: public; Owner: netbox
--

ALTER TABLE public.netbox_physical_clusters_physicalclustertype ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.netbox_physical_clusters_physicalclustertype_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
473	Can add cluster type	119	add_clustertype
474	Can change cluster type	119	change_clustertype
475	Can delete cluster type	119	delete_clustertype
476	Can view cluster type	119	view_clustertype
...
498	Can add physical cluster type	126	add_physicalclustertype
499	Can change physical cluster type	126	change_physicalclustertype
500	Can delete physical cluster type	126	delete_physicalclustertype
501	Can view physical cluster type	126	view_physicalclustertype
\.
...
125	django_rq	queue
126	netbox_physical_clusters	physicalclustertype
\.
...
459	netbox_physical_clusters	0001_initial	2023-09-29 17:22:33.723786+00
...
--
-- Data for Name: netbox_physical_clusters_physicalclustertype; Type: TABLE DATA; Schema: public; Owner: netbox
--

COPY public.netbox_physical_clusters_physicalclustertype (id, created, last_updated, custom_field_data, name, description, comments) FROM stdin;
...
--
-- Name: netbox_physical_clusters_physicalclustertype_id_seq; Type: SEQUENCE SET; Schema: public; Owner: netbox
--

SELECT pg_catalog.setval('public.netbox_physical_clusters_physicalclustertype_id_seq', 4, true);
...
--
-- Name: netbox_physical_clusters_physicalclustertype netbox_physical_clusters_physicalclustertype_name_key; Type: CONSTRAINT; Schema: public; Owner: netbox
--

ALTER TABLE ONLY public.netbox_physical_clusters_physicalclustertype
    ADD CONSTRAINT netbox_physical_clusters_physicalclustertype_name_key UNIQUE (name);


--
-- Name: netbox_physical_clusters_physicalclustertype netbox_physical_clusters_physicalclustertype_pkey; Type: CONSTRAINT; Schema: public; Owner: netbox
--

ALTER TABLE ONLY public.netbox_physical_clusters_physicalclustertype
    ADD CONSTRAINT netbox_physical_clusters_physicalclustertype_pkey PRIMARY KEY (id);
...
--
-- Name: netbox_physical_clusters_physicalclustertype_name_fa1f530f_like; Type: INDEX; Schema: public; Owner: netbox
--

CREATE INDEX netbox_physical_clusters_physicalclustertype_name_fa1f530f_like ON public.netbox_physical_clusters_physicalclustertype USING btree (name varchar_pattern_ops);
